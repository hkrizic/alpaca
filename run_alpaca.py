"""
Lens Modeling Pipeline Script

Entry-point script for the complete TDLMC lens modeling pipeline. Configures
and runs all phases: PSF reconstruction, MAP optimization, and posterior sampling.
...
Edit run_config.py to change settings, then run this script.
...
def main():
    ...
    print("\nEdit run_config.py to change configuration settings.")
    print("\nStarting pipeline...\n")
    ...
    # --- 4.1 PSF Reconstruction Results ---
    ...
    # --- 4.2 Multi-start Optimization Results ---
    ...
    # --- 4.3 Posterior Sampling Results ---
    if "posterior" in results and results["posterior"] is not None:
        ...
        if key_params_plot:
            ...
            if len(key_params_plot) == 1: axes = [axes]
